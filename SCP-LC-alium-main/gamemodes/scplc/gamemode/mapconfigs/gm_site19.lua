...
SPAWN_Bigfoot = Vector ( 1876.49, 285.49, 55.96 )
...
SPAWN_CONTROL = {
	Vector( -2529.00, 4087.00, 300.00 ),
}

SPAWN_SPECIALIST = {
	Vector( 5440.345215, 512.648926, -500.968750 ),
	Vector( 4799.060547, -2746.427734, 36.031246 ),
	Vector( 5875.600586, -189.013016, 20.031250),
}

SPAWN_SH = {
	Vector( 1472.240479, -1737.535278, -777.968750 ),
	Vector( 4801.103516, 1078.587280, 10.031250 ),
	Vector( 5101.079590, 3652.974121, 10.031242 ),
}


SPAWN_HEAVYMTF = { 	
    Vector( 782.00, 4551.00, 27.00 ),
	Vector( 854.00, 4549.00, 27.00 ),
	Vector( 854.00, 4316.00, 29.00 ),
	Vector( 791.00, 4315.00, 29.00 ),
	Vector( 785.00, 4128.00, 24.00 ),
	Vector( 868.00, 4100.00, 24.00 ),	
}
...
SPAWN_SUPPORT_CI = {
	Vector( 489.31, 6718.84, 2220.03 ),
	Vector( 239.37, 6721.21, 2220.03 ),
	Vector( 558.00, 7110.26, 2068.04 ),
	Vector( 561.40, 6979.96, 2043.20 ),
	Vector( 599.99, 6857.49, 2073.03 ),
	Vector( 504.73, 6834.90, 2074.58 ),
	Vector( 505.45, 6972.61, 2074.37 ),
	Vector( 520.38, 7117.55, 2070.18 ),
	Vector( 80.41, 6723.86, 2220.03 ),
	Vector( 2.79, 6866.84, 2212.03 ),
	Vector( 0.18, 6985.37, 2212.03 ),
	Vector( -10.49, 7129.19, 2212.03 ),
}

SPAWN_SUPPORT_GOC = {
	Vector( -2717.542236, 1716.792114, 2396.031250 ),
	Vector( -2838.560059, 1755.901001, 2396.031250 ),
	Vector( -2936.457520, 1754.329468, 2396.031250 ),
	Vector( -2981.198730, 1717.887573, 2396.031250 ),
	Vector( -3059.035156, 1738.700195, 2296.031250 ),
	Vector( -2721.146484, 1883.168579, 2296.031250 ),
	Vector( -2804.054688, 1897.068481, 2296.031250 ),
	Vector( -2872.809570, 1898.538452, 2296.031250 ),
	Vector( -2955.304199, 1897.539429, 2296.031250 ),
	Vector( -3022.890869, 1897.093628, 2296.031250 ),
}
...
CHIPS = {
	...
	ez_3 = {
		...
		spawns = {
			...
			Vector ( 4013.064209, -919.522644, -103.718750)
		},
	},
	lv5 = {
		amount = 3,
		level = 5,
		spawns = {
			Vector( 3733.00, 4867.33, 733.00 ),
			Vector( 6483.00, 4782.00, -1052.00 ),
		},
	},
}
...
--	Vector( 5034.00, -2263.00, 63.00 ),
	...
	--chaos
	-- Vector( -80.00, 6672.03, 2220.03 ),
--	Vector( -160.00, 6672.03, 2220.03 ),
	-- Vector( -240.00, 6672.03, 2220.03 ),
}

--[[-------------------------------------------------------------------------
Spawn weapons
---------------------------------------------------------------------------]]
SPAWN_PARTICLE_CANNON = {
	Vector( 3577.00, 1715.00, 60.00 ),
	Vector( 6471.00, 3837.00, -1025.00 ),
}
...
SPAWN_PISTOLS = {
	...
	Vector(-1570.462890625, -524.64221191406, 36.031246185303),
	Vector(-1626.5120849609, -526.12976074219, 36.03125),
	Vector(1404.8734130859, -1127.7232666016, 95.28125),
	Vector(691.81518554688, -1770.794921875, 40.03125),
	Vector(1591.7481689453, 57.180755615234, -767.96875),
	Vector(1715.6575927734, 470.5085144043, 0.031242370605469),
...
SPAWN_SMGS = {
	...
	Vector(5030.8188476563, -2264.0559082031, 52.031253814697),
...
SPAWN_PUMP = {
	...
	Vector(-448.08154296875, -27.739624023438, -219.96875),
...
Omega warhead
---------------------------------------------------------------------------]]
OMEGA_ACTIVATION_1 = { Vector( 4154.332031, 161.003433, -319.968750 ), Angle( 0, -270, 0 ) }
OMEGA_ACTIVATION_2 = { Vector( 3970.031250, 715.664185, -324.632446 ), Angle( 0, 0, 0 ) }
