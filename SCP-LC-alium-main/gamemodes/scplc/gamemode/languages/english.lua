...
vest.guardchief = "Guard Chief Vest"
...
vest.goc = "Global Occult Coalition Vest"
vest.goc_com = "Global Occult Coalition Leader Vest"
vest.goc_sct = "Global Occult Coalition Light Vest"
vest.goc_med = "Global Occult Coalition Medic Vest"
...
classes.cont_spec = "Contaiment Specialist"
...
classes.shspy = "Serpent Head Servant"

classes.gocsoldier = "Global Occult Coalition Unit"
classes.goccom = "Global Occult Coalition Commander"
classes.gocscout = "Global Occult Coalition Scout"
classes.gocmed = "Global Occult Coalition Medic"
...
sh_spy = [[ - Help SCP objects and rescue them
- Avoid Staff or Eliminate Them ]],

gocsoldier = [[ - Eliminate everyone in the facility
- Listen to your orders from GOC commander
- Help the commander activate the alpha warhead in the complex. ]],

goccom = [[ - Eliminate everyone in the facility
- Give orders to GOC units
- Activate the alpha warhead at the complex. ]],

gocscout = [[ - Eliminate everyone in the facility
- Listen to your orders from GOC commander
- Help the commander activate the alpha warhead in the complex ]],

gocmed = [[ - Eliminate everyone in the facility
- Listen to your orders from GOC commander
- Help the commander activate the alpha warhead in the complex ]],
...
Overview:
Contaiment specialist. Appears in high contaiment zone. Cooperate with facility staff and stay away from SCPs. You can be escorted by MTFs members.
]],
...
gocsoldier = [[Difficulty: Very High
Toughness: Unknown
Agility: Unknown
