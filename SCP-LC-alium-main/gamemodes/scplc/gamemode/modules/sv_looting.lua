...
AddLootPool( "lcz_military_crate", {
	...
	chance = 0.2,
	items = {
		{ class = "swb_deagle", weight = 5 },
		{ class = "swb_glock18", weight = 5 },
		{ class = "swb_357", weight = 5 },
...
AddLootPool( "hcz_035", {
	...
	items = {
		...
		{ class = "swb_deagle", weight = 5, value = 251 },
		{ class = "swb_glock18", weight = 5, value = 251 },
		{ class = "swb_357", weight = 5, value = 251 },
