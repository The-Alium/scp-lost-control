...
function GM:SpawnItems()
	...
	if USE_LEGACY_ITEMS_SPAWN then
		...
		SpawnItemGeneric( { "swb_deagle", "swb_glock18", "swb_357", "swb_fiveseven" }, SPAWN_PISTOLS, -1, post )
		SpawnItemGeneric( { "swb_mac10", "swb_tmp", "swb_mp5", "swb_p90" }, SPAWN_SMGS, -1, post )
		SpawnItemGeneric( { "swb_ak47", "swb_m4a1", "swb_galil", "swb_sg552", "swb_famas", "swb_aug", "swb_sg550" }, SPAWN_RIFLES, -1, post )
		SpawnItemGeneric( { "swb_m3super90", "swb_xm1014", "swb_shotgun" }, SPAWN_PUMP, -1, post )
		SpawnItemGeneric( { "swb_awp", "swb_scout", "swb_g3sg1" }, SPAWN_SNIPER, -1, post )
