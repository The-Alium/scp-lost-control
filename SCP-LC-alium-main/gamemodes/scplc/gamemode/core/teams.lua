...
SCPTeams.Register( "DESERTER", bit.bor( SCPTeams.INFO_ALIVE, SCPTeams.INFO_HUMAN ), Color( 148, 124, 18), 1, true )
...
SCPTeams.Register( "GOC", bit.bor( SCPTeams.INFO_ALIVE, SCPTeams.INFO_HUMAN ), Color( 21, 172, 139), 3, false )
SCPTeams.Register( "SH", bit.bor( SCPTeams.INFO_ALIVE, SCPTeams.INFO_HUMAN ), Color( 133, 12, 52), 5, true )

SCPTeams.SetupAllies( { TEAM_CLASSD, TEAM_CI,} )
SCPTeams.SetupAllies( { TEAM_CLASSD, TEAM_DESERTER,} )
SCPTeams.SetupAllies( { TEAM_SCI, TEAM_MTF } )
SCPTeams.SetupAllies( { TEAM_SCI, TEAM_DESERTER } )


SCPTeams.SetupEscort( TEAM_MTF, TEAM_SCI )
SCPTeams.SetupEscort( TEAM_CI, TEAM_CLASSD )
-- SCPTeams.SetupEscort( TEAM_DESERTER, TEAM_CLASSD )
-- SCPTeams.SetupEscort( TEAM_DESERTER, TEAM_SCI )
