...
AddGamemodeContent("827243834") -- SCP 173 Player Model
...
AddGamemodeContent("1681584444") -- MW2 Juggernaut Playermodel
-- AddGamemodeContent("400617936") -- [Re-Upload] COD4 Sniper Playermodel
-- AddGamemodeContent("713147934") -- Alex Vestin's Operators-Playermodels
-- AddGamemodeContent("232636218") -- PMC playermodels