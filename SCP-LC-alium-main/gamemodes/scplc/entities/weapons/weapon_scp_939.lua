...
DefineUpgradeSystem( "scp939", {
	...
	upgrades = {
		...
		{ name = "heal2", cost = 2, req = { "heal1" }, reqany = false,  pos = { 1, 2 }, mod = { heal = 100 }, active = false },
		{ name = "heal3", cost = 3, req = { "heal2" }, reqany = false,  pos = { 1, 3 }, mod = { heal = 150 }, active = false },
