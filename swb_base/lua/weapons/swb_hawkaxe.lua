...
SWEP.ViewModel		= "models/jessev92/hl2/weapons/fasthawk_v.mdl"
SWEP.WorldModel		= "models/jessev92/hl2/weapons/fasthawk_w.mdl"
SWEP.UseHands = true
...
SWEP.HitSound = Sound("npc/ministrider/flechette_flesh_impact1.wav")
