...
function SWEP:PreDrawViewModel()
	...
	elseif self.dt.State == SWB_RUNNING or (((len > ws * 1.2 and self:GetOwner():KeyDown(IN_SPEED)) or len > ws * 3 or (self.ForceRunStateVelocity and len > self.ForceRunStateVelocity)) and self:GetOwner():OnGround()) then
